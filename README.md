...
- [Rockbase Console operations](docs/console-operations.md) — bilingual EN/中文 workbench and Docker Compose runtime
...
- [Rockbase 控制台运维指南](docs/console-operations.md) — 中英文切换与 Docker Compose 运行
