...
def main() -> None:
    parser = argparse.ArgumentParser(description="Augment an existing YouTube KOL L2 CSV with contact page email crawl.")
    parser.add_argument("--input-csv", required=True, help="Path to an existing YouTube L2 enriched CSV.")
    ...
    write_csv(output_csv, rows, preferred_fields=YOUTUBE_L2_REQUIRED_FIELDS + YOUTUBE_L2_FLEX_FIELDS)
    write_json(
        runlog_json,
        {
