...
DEFAULT_OUTPUT = project_path("workbench", "rockbase-gmail-reply-recovery-v3", "runs", "2026-03-26_run-001", "part2_reply_blocks_preview.csv")
DEFAULT_SUMMARY = project_path("workbench", "rockbase-gmail-reply-recovery-v3", "runs", "2026-03-26_run-001", "part2_reply_blocks_preview_summary.md")
